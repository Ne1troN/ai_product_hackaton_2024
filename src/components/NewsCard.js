  ...
  return (
    <>
      <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        ...
        <p class="mb-3 font-normal text-gray-500 dark:text-gray-400">{ summary }</p>
        <a href={sourceLink} class="inline-flex font-medium items-center text-blue-600 hover:underline">
            К источнику
