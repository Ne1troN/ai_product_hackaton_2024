  ...
  return (
    <>
      <div class="text-center">
        <div role="status" class="flex flex-col items-center mt-10 mb-4">
          <svg xmlns="http://www.w3.org/2000/svg" class="w-12 h-12 fill-red-600 dark:fill-red-500" shape-rendering="geometricPrecision" text-rendering="geometricPrecision" image-rendering="optimizeQuality" fill-rule="evenodd" clip-rule="evenodd" viewBox="0 0 511.999 463.377">
